                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="alternateText" class="form-control"
                                   value="<?= $photo->alternate_text; ?>">
                        </div>
                        <div class="form-group">
                            <label for="description">Description</label>
                            <!--  Szerkeszthető textares: https://www.tiny.cloud/docs/quick-start/  -->
                            <textarea class="form-control" name="description" id="mytextarea" cols="30"
                                      rows="10"><?= $photo->description ?>
                        </textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div id="dataBox" class="photo-info-box">
                            ...
                            <div class="inside">
                                ...
                                <div class="info-box-footer clearfix">
                                    <div class="info-box-delete pull-left">
                                        <a href="photos.php?id=<?php echo $photo->id; ?>&path=photos.php&class=photo"
